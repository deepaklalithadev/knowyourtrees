...
class treeinfo(models.Model):
    ...
    treepic = models.ImageField(default='default.jpg',upload_to='images/')
    trunkdesc = models.CharField(max_length=300,blank=True)
    trunkpic = models.ImageField(default='default.jpg',upload_to='images/',blank=True)
    leavesdesc = models.CharField(max_length=300,blank=True)
    leavespic = models.ImageField(default='default.jpg',upload_to='images/',blank=True)
    flowerdesc = models.CharField(max_length=300,blank=True)
    flowerpic = models.ImageField(default='default.jpg',upload_to='images/',blank=True)
    other1desc = models.CharField(max_length=300,blank=True)
    other1pic = models.ImageField(default='default.jpg',upload_to='images/',blank=True)
    other2desc = models.CharField(max_length=300,blank=True)
    other2pic = models.ImageField(default='default.jpg',upload_to='images/',blank=True)
